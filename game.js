...
export class Game {
  ...
  populateZombies(){
    for (let i = 0; i < 5; i++) {
      ...
      this.zombies[i] = {
        id: i,
        obj: new Player("zombie",this.canvas, randomX, randomY, 32, playerImage)
      }
        // new Player("zombie",this.canvas, randomX, randomY, 32, playerImage)
      // )
    }
  }
  ...
  drawZombies(){
    ...
    //   if (this.player.fireball){
    //     if (zombie.detectHit(this.player.fireball)){
    //       this.zombies.indexOf(zombie)
    //     }
    //   }
    //   zombie.draw()
    // })
